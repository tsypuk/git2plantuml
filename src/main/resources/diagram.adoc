[plantuml, 8d6cfb3c-f7b5-4ad0-84cf-61f567476966, png, title="Git repository snapshot: 4 commits, 4 trees, 2 blobs, 2 refs: HEAD,refs/heads/master", width=1000, height=1000]
....
