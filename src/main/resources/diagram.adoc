[plantuml, cc51a75c-3937-47b4-898d-7fd73c99d01f, png, title="Git repository snapshot: 4 commits, 4 trees, 2 blobs, 2 refs: HEAD,refs/heads/master", width=1000, height=1000]
....
